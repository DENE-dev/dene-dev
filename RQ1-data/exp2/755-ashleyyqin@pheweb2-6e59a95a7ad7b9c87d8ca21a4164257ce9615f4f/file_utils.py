...
common_filepaths = {
    ...
    # TODO: eventually correlations will be generated by PheWeb; providing the file at all is a temporary measure
    'correlations-raw': (lambda: os.path.join(conf.data_dir, 'pheno-correlations.txt')),
    'genes': (lambda: get_cacheable_file_location('sites/genes', 'genes-{}.bed'.format(genes_version))),
    'gene-aliases-trie': (lambda: get_cacheable_file_location('sites/genes', 'gene_aliases-v{}-hg19.marisa_trie'.format(genes_version))),
    'rsids': (lambda: get_cacheable_file_location('sites/dbSNP', 'rsids-{}.vcf.gz'.format(dbsnp_version))),
    ...
    'best-phenos-by-gene': (lambda: get_generated_path('best-phenos-by-gene.json')),
    'correlations': (lambda: get_generated_path('pheno-correlations.txt')),
    'cpra-to-rsids-trie': (lambda: get_generated_path('sites/cpra_to_rsids_trie.marisa')),
    'rsid-to-cpra-trie': (lambda: get_generated_path('sites/rsid_to_cpra_trie.marisa')),
